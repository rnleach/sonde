...
pub fn make_overlay_frame(ac: &AppContextPointer) -> ScrolledWindow {
    ...
    build_config_color!(skewt_box, "PFT - Mean Specific Humidity", ac, pft_mean_q_color);
    build_config_color!(skewt_box, "PFT - Mean Potential Temperature", ac, pft_mean_theta_color);
    build_config_color!(skewt_box, "PFT - Parcel (fc) Potential Temperature", ac, pft_fc_theta_color);
